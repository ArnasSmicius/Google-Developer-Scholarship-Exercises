...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 592;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 476;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent intent = PendingIntent.getService(context,
